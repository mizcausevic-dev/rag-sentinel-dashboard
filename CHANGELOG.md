...
### Released
- Released **rag-sentinel-dashboard** publicly as a reviewable operating system for ai retrieval reliability.
...
### Shipped
- Cut the first coherent internal version of **rag-sentinel-dashboard** with stable domain objects, review surfaces, and decision outputs.
